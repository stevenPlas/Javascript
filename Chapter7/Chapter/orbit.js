...
function displayCalendar(whichMonth) {
    ...
    var month;
    var year;
    var monthArray = ["January", "Febuary", "March", "April", "May",
    ...
    if (month === 0 || month === 2 || month === 4 ||
        ...
        if (year % 4 === 0) { // Leap year test
            if (year % 100 === 0) {
                //year ending in 00 not a leap yeare unless devisible by 400
                if (year % 400 === 0) {
                    daysInMonth = 28;
                } else {
                    daysInMonth = 28;
    ...
    // display calender if it's not already visible
}

// select the date
function selectDate(event) {
    if (event === undefined) { // get caller elements in IE8
        event = window.event;
    }
...
function registerName() {
    ...
    //  document.getElementById("fName").value = " "; //This line was throwing an error, saying I could not set value to null
    //  document.getElementById("lName").value = " "; //This line was throwing an error, saying I could not set value to null
