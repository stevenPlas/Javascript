...
function getWeather(evt) {
    ...
    var url = "https://api.darksky.net/forecast/4a3764069dbc3a70e3519c2d4d5417f1/" + latitude + "," + longitude + "?callback=getForecast"
...
function fillWeather(weatherReport) {
        ...
        var rows = document.querySelectorAll("section.week tabletbody tr");
